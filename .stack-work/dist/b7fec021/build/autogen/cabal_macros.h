...
/* package webhaskell-0.1.0.0 */
#define VERSION_webhaskell "0.1.0.0"
#define MIN_VERSION_webhaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "webhaskell-0.1.0.0-G3xyQN2osLiGKWGHxJyv54"

#define CURRENT_PACKAGE_KEY "webhaskell-0.1.0.0-G3xyQN2osLiGKWGHxJyv54"
